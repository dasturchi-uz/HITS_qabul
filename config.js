...
const CONFIG = {
  ...
  supabase: {
    url: 'https://halphorcsdtrnudluqzt.supabase.co', // e.g., 'https://your-project.supabase.co'
    key: 'sb_publishable_E2yIxlz8GswFJn-zfnzpxQ_ZsxqEMoy' // e.g., 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...'
  },
